...
public class LectureTemplate extends StorableAsXML {
    @Attribute(name="version")
    private String version="2.0";

    @Element(name="channel")
    private ChannelTemplateForLecture channel=null;

    public LectureTemplate(){ // needed to be a bean for XMLSerialization
       channel=new ChannelTemplateForLecture();
    }
    public ChannelTemplateForLecture getChannel(){
        return channel;
    }
